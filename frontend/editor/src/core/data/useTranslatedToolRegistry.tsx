  ...
  return useMemo(() => {
    const allTools: ToolRegistry = {
      ...
      scannerImageSplit: {
        icon: (
          <LocalIcon
            icon="auto-fix-rounded"
            width="1.5rem"
            height="1.5rem"
          />
        ),
        name: t("home.scannerImageSplit.title", "Photo Splitter"),
        component: lazy(() => import("@app/tools/ScannerImageSplit")),
        description: t(
          "home.scannerImageSplit.desc",
          "Extract scanned images from a PDF file",
        ),
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.ADVANCED_FORMATTING,
        maxFiles: -1,
      ...
      devFolderScanning: {
        ...
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.DEVELOPER_TOOLS,
        link: "https://docs.totalpdf.com/Configuration/Folder%20Scanning/",
      ...
      devSsoGuide: {
        ...
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.DEVELOPER_TOOLS,
        link: "https://docs.totalpdf.com/Configuration/Single%20Sign-On%20Configuration/",
      ...
      devAirgapped: {
        ...
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.DEVELOPER_TOOLS,
        link: "https://docs.totalpdf.com/Paid-Offerings/#activating-your-license",
