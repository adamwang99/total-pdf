    ...
    <Stack gap={20} p={0}>
      <Text size="sm" c="dimmed">
        {t(
          ...
          "Use your API key to programmatically access Total PDF's processing capabilities.",
        )}
      </Text>
          ...
          <Stack gap={8} style={{ flex: 1 }}>
            ...
            <Text size="sm" c="dimmed">
              {t(
                ...
                "Learn more about integrating with Total PDF:",
              )}
            </Text>
            <Stack gap={4}>
              <Text size="sm">
                <Anchor
                  href="https://docs.totalpdf.info/API"
                  target="_blank"
              ...
              <Text size="sm">
                <Anchor
                  href="https://registry.scalar.com/@aiworld/apis/total-pdf-processing-api/"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{
                    display: "inline-flex",
